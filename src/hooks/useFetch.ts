...
export const useFetch = (resource: string) => {
    const get: Function = async (body?: any) => {
        ...
        try {
            ...
            const res: Response = await fetch(`/${resource.trim().toLocaleLowerCase()}?filter=${filter}&selects=${selects}`, {
                method: "GET",
                // mode: "cors",
                headers: {
    ...
    const post: Function = async (body: any) => {
        try {
            ...
            const res: Response = await fetch(`/${resource}`, {
                method: "POST",
                // mode: "cors",
                headers: {
                    "content-type": "application/json",
    ...
    const patch: Function = async (body: any) => {
        try {
            ...
            const res: Response = await fetch(`/${resource}/${body.id}`, {
                method: "PATCH",
                // mode: "cors",
                headers: {
                    "content-type": "application/json",
